...
class TestListCreateUser(APITestCase):
    ...
    def test_post_request_returns_400_when_create_users_with_wrong_first_name(
        self,
    ):
        data = {
            "email": "camille@gmail.com",
    ...
    def test_post_request_returns_400_when_create_users_with_wrong_last_name(
        self,
    ):
        data = {
            "email": "camille@gmail.com",
    ...
    def test_post_request_returns_400_when_create_users_with_wrong_mobile_phone(
        self,
    ):
        data = {
            "email": "camille@gmail.com",
...
class TestRetrieveUpdateDestroyUser(APITestCase):
    ...
    def test_get_request_access_authenticated_dev_user_no_owner_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_dev_user)
    ...
    def test_get_request_return_correct_data_dev_user_authenticated_and_owner(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_dev_user)
    ...
    def test_get_request_access_authenticated_pm_user_cant_see_super_users_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_pm_user)
    ...
    def test_put_request_access_authenticated_pm_user_no_owner_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_pm_user)
    ...
    def test_put_request_access_authenticated_dev_user_no_owner_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_dev_user)
    ...
    def test_put_request_no_admin_user_authenticated_and_owner_returns_correct_data(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_dev_user)
    ...
    def test_patch_request_access_authenticated_pm_user_no_owner_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_pm_user)
    ...
    def test_patch_request_access_authenticated_dev_user_no_owner_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_dev_user)
    ...
    def test_delete_request_access_authenticated_pm_user_no_owner_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_pm_user)
    ...
    def test_delete_request_access_authenticated_dev_user_no_owner_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_dev_user)
    ...
    def test_delete_request_access_authenticated_dev_user_owner_returns_204(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_dev_user)
    ...
    def test_delete_request_access_authenticated_pm_user_owner_returns_204(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_pm_user)
    ...
    def test_delete_request_access_authenticated_admin_user_only_change_attributes_deleted_and_is_active(
        self,
    ):
        response = self.client.delete("/api/v1/accounts/users/1")
        self.assertEqual(response.status_code, 204)
...
class TestLoginUser(APITestCase):
    ...
    def test_post_request_with_valid_data_return_200(self):
        data = {"email": "robert@gmail.com", "password": "Pass*2024*"}
    ...
    def test_post_request_invalid_user_credentials_email(self):
        data = {"email": "wrongemail@gmail.com", "password": "Pass*2024*"}
        response = self.client.post("/api/v1/accounts/users/login", data=data)
        self.assertEqual(response.status_code, 401)

    def test_post_request_invalid_user_credentials_password(self):
        data = {"email": "robert@gmail.com", "password": "wrongpass"}
        response = self.client.post("/api/v1/accounts/users/login", data=data)
        self.assertEqual(response.status_code, 401)
...
class TestListProjectManagerUsers(APITestCase):
    ...
    def test_get_request_dont_returns_list_of_non_active_and_deleted_users(
        self,
    ):
        self.test_pm_user = User.objects.create_user(

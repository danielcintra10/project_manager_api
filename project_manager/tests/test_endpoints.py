...
class TestBaseClass(APITestCase):
    ...
    def setUp(self):
        self.test_dev_user = User.objects.create_user(
            id=1,
        ...
        self.test_dev_user_2 = User.objects.create_user(
            id=2,
        ...
        self.test_dev_user_3 = User.objects.create_user(
            id=3,
        ...
        self.test_pm_user = User.objects.create_user(
            id=4,
        ...
        self.test_pm_user_2 = User.objects.create_user(
            id=5,
        ...
        self.test_task = Task.objects.create(
            code="test-task-01-2024",
            title="Test Task",
            description="Task Description",
            developer=self.test_dev_user,
            project=self.test_project,
            is_completed=False,
            final_date=date(9999, 10, 10),
            created_by=self.test_pm_user,
            updated_by=self.test_pm_user,
        )

        self.test_task_2 = Task.objects.create(
            code="test-task-02-2024",
            title="Test Task number 2",
        ...
        self.test_task_3 = Task.objects.create(
            code="test-task-03-2024",
            title="Test Task number 3",
            description="Task Description for task 3",
            developer=self.test_dev_user_2,
            project=self.test_project,
            is_completed=False,
            final_date=date(9999, 10, 10),
...
class TestListCreateProject(TestBaseClass):
    ...
    def test_get_request_dont_returns_list_of_active_and_non_deleted_projects(
        self,
    ):
        new_project = Project.objects.create(
            code="test-project-02-2024",
            name="Test Project 2",
        ...
        new_project_2 = Project.objects.create(
            code="test-project-03-2024",
            name="Test Project 3",
    ...
    def test_post_request_unauthenticated_user_returns_401(self):
        ...
        response = self.client.post(
            "/api/v1/project-manager/projects/", data=data
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_post_request_with_valid_data_creates_new_project_and_set_code_auto(
        self,
    ):
        data = {
            "name": "New Project Created",
    ...
    def test_post_request_with_valid_data_sets_created_by_and_updated_by_fields_to_current_user(
        self,
    ):
        data = {
            "name": "New Project Created",
    ...
    def test_post_request_return_correct_data(self):
        ...
        self.assertEqual(
            response.data["project_manager"], project.project_manager.id
        )
    ...
    def test_post_request_invalid_data_types_returns_400(self):
        data = {"field": 2, "wrong field": True, "project_manager": "2"}
        response = self.client.post(
            "/api/v1/project-manager/projects/", data=data
        )
        self.assertEqual(response.status_code, 400)
...
class TestRetrieveUpdateDestroyProject(TestBaseClass):
    ...
    def test_get_request_unauthenticated_user_returns_401(self):
        ...
        response = self.client.get(
            "/api/v1/project-manager/projects/test-project-01-2024/"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_get_request_returns_correct_data(self):
        ...
        self.assertEqual(
            response.data["description"], self.test_project.description
        )
        self.assertEqual(
            response.data["project_manager"],
            self.test_project.project_manager.id,
        )
        self.assertEqual(
            response.data["is_active"], self.test_project.is_active
        )
    ...
    def test_put_request_correct_data_returns_200(self):
        ...
        response = self.client.put(
            "/api/v1/project-manager/projects/test-project-01-2024/", data=data
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_put_request_returns_correct_data(self):
        ...
        self.assertEqual(
            "Project description updated for tests", project.description
        )
    ...
    def test_patch_request_wrong_project_manager_returns_400(self):
        data = {"name": "Project Updated", "project_manager": 2}
        response = self.client.patch(
            "/api/v1/project-manager/projects/test-project-01-2024/", data=data
        )
        self.assertEqual(response.status_code, 400)
...
class TestListCreteTask(TestBaseClass):
    ...
    def test_get_request_dont_returns_list_of_active_and_non_deleted_projects(
        ...
        new_task = Task.objects.create(
            code="test-task-04-2024",
            title="Test Task number 4",
        ...
        new_task_2 = Task.objects.create(
            code="test-task-05-2024",
            title="Test Task number 5",
    ...
    def test_post_request_unauthenticated_user_returns_401(self):
        ...
        response = self.client.post(
            "/api/v1/project-manager/tasks/", data=data
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_post_request_with_valid_data_creates_new_task_and_set_code_auto(
        self,
    ):
        data = {
            "title": "New Task Created",
    ...
    def test_post_request_return_correct_data(self):
        ...
        self.assertEqual(
            response.data["final_date"], task.final_date.isoformat()
        )
...
class TestRetrieveUpdateDestroyTask(TestBaseClass):
    ...
    def test_get_request_unauthenticated_user_returns_401(self):
        self.client = APIClient()
        response = self.client.get(
            "/api/v1/project-manager/tasks/test-task-01-2024/"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_get_request_authenticated_user_returns_correct_data(self):
        ...
        self.assertEqual(
            response.data["description"], self.test_task.description
        )
        self.assertEqual(
            response.data["developer"], self.test_task.developer.id
        )
        self.assertEqual(
            response.data["is_completed"], self.test_task.is_completed
        )
        self.assertEqual(
            response.data["final_date"], self.test_task.final_date.isoformat()
        )
        self.assertEqual(response.data["is_active"], self.test_task.is_active)

    def test_get_request_wrong_data_returns_404(self):
        response = self.client.get(
            "/api/v1/project-manager/tasks/0897456-task/"
        )
        self.assertEqual(response.status_code, 404)
    ...
    def test_put_request_unauthenticated_user_returns_401(self):
        ...
        response = self.client.put(
            "/api/v1/project-manager/tasks/test-task-01-2024/", data=data
        )
        self.assertEqual(response.status_code, 401)

    def test_put_request_authenticated_dev_user_no_task_developer_returns_403(
        self,
    ):
        data = {
            "title": "Task Updated",
    ...
    def test_put_request_authenticated_dev_user_task_developer_returns_200(
        self,
    ):
        data = {
            "title": "Task Updated",
    ...
    def test_patch_request_authenticated_dev_user_no_task_developer_returns_403(
        self,
    ):
        data = {
            "title": "Task Updated",
    ...
    def test_patch_request_authenticated_dev_user_task_developer_returns_200(
        self,
    ):
        data = {
            "title": "Task Updated",
    ...
    def test_patch_request_returns_correct_data(self):
        data = {"title": "Task Updated", "developer": 2}
        response = self.client.patch(
            "/api/v1/project-manager/tasks/test-task-01-2024/", data=data
        )
        self.assertEqual(response.status_code, 200)
...
class TestListProjectsByProjectManager(TestBaseClass):
    ...
    def test_get_request_authenticated_user_returns_200_and_count_equal_1(
        self,
    ):
        response = self.client.get("/api/v1/project-manager/projects/4")
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_request_dont_returns_list_of_another_project_manager_projects(
        self,
    ):
        new_project = Project.objects.create(
            code="test-project-02-2024",
            name="Test Project 2",
            description="Project Description for project 2",
            project_manager=self.test_pm_user_2,
            created_by=self.test_pm_user,
            updated_by=self.test_pm_user,
        )
        new_project_2 = Project.objects.create(
...
class TestListTasksByDeveloper(TestBaseClass):
    ...
    def test_get_request_access_authenticated_unrequested_dev_user_returns_403(
        self,
    ):
        self.client = APIClient()
        refresh = RefreshToken.for_user(self.test_dev_user_2)
    ...
    def test_get_request_authenticated_user_returns_200_and_count_equal_to_2(
        self,
    ):
        response = self.client.get("/api/v1/project-manager/tasks/1")
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_request_dont_returns_list_of_non_active_and_deleted_tasks(
        self,
    ):
        new_task = Task.objects.create(
            code="test-task-04-2024",
...
class TestListDeveloperTasksInProject(TestBaseClass):
    ...
    def test_get_request_access_unauthenticated_user_returns_401(self):
        self.client = APIClient()
        response = self.client.get(
            "/api/v1/project-manager/tasks/1/test-project-01-2024"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_wrong_user_id_returns_400(self):
        response = self.client.get(
            "/api/v1/project-manager/tasks/user-wrong-id/test-project-01-2024"
        )
        self.assertEqual(response.status_code, 404)

    def test_wrong_project_code_returns_404(self):
        response = self.client.get(
            "/api/v1/project-manager/tasks/1/wrong-project-code"
        )
        self.assertEqual(response.status_code, 404)
...
class TestListAvailableDevelopers(TestBaseClass):
    ...
    def test_get_request_access_unauthenticated_user_returns_401(self):
        self.client = APIClient()
        response = self.client.get(
            "/api/v1/project-manager/available-developers/"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_get_request_dont_returns_list_of_non_active_and_deleted_dev_users(
        self,
    ):
        self.test_dev_user = User.objects.create_user(
            id=6,
...
class TestEnableProject(TestBaseClass):
    ...
    def test_put_request_access_unauthenticated_user_returns_401(self):
        self.client = APIClient()
        response = self.client.put(
            "/api/v1/project-manager/projects/test-project-01-2024/enable"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_put_request_authenticated_user_returns_200(self):
        ...
        response = self.client.put(
            "/api/v1/project-manager/projects/test-project-02-2024/enable"
        )
        self.assertEqual(response.status_code, 200)
...
class TestDisableProject(TestBaseClass):
    ...
    def test_delete_request_access_unauthenticated_user_returns_401(self):
        self.client = APIClient()
        response = self.client.delete(
            "/api/v1/project-manager/projects/test-project-01-2024/disable"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_delete_request_deactivate_correctly_a_project(self):
        ...
        self.assertEqual(Project.objects.filter(is_active=True).count(), 2)
        response = self.client.delete(
            "/api/v1/project-manager/projects/test-project-02-2024/disable"
        )
        self.assertEqual(response.status_code, 204)
        self.assertEqual(Project.objects.filter(is_active=True).count(), 1)
...
class TestEnableTask(TestBaseClass):
    ...
    def test_put_request_access_unauthenticated_user_returns_401(self):
        self.client = APIClient()
        response = self.client.put(
            "/api/v1/project-manager/tasks/test-task-01-2024/enable"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_put_request_authenticated_user_returns_200(self):
        self.test_task_4 = Task.objects.create(
            code="test-task-04-2024",
            title="Test Task 4",
        ...
        response = self.client.put(
            "/api/v1/project-manager/tasks/test-task-04-2024/enable"
        )
        self.assertEqual(response.status_code, 200)
...
class TestDisableTask(TestBaseClass):
    ...
    def test_delete_request_access_unauthenticated_user_returns_401(self):
        self.client = APIClient()
        response = self.client.delete(
            "/api/v1/project-manager/tasks/test-task-01-2024/disable"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_delete_request_activates_correctly_a_project(self):
        ...
        self.assertEqual(Task.objects.filter(is_active=True).count(), 4)
        response = self.client.delete(
            "/api/v1/project-manager/tasks/test-task-04-2024/disable"
        )
        self.assertEqual(response.status_code, 204)
        self.assertEqual(Task.objects.filter(is_active=True).count(), 3)
